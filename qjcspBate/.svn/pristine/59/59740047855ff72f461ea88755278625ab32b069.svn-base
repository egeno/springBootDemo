			...
			$(function() {
				...
				$grid=$dg.datagrid({
					...
					columns : [ [ {field : 'userId',title : '用户ID',align : 'center',align : 'left',editor : "text"},
					              ...
					              {field : 'userAccount',title : '登陆账号',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"},
