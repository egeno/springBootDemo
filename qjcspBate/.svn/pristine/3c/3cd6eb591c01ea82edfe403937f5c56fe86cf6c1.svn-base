...
//获得可评价菜品列表
	public Map<String, Object> getSayEvaluationGoods(String orderNum) {
	...
	public Map<String, Object> commitEvaluationGoods(JSONObject res)  {
...
//获取评价详情
	public Map<String, Object> getEvaluationDetails(JSONObject res) {
		Map<String, Object> returnData = new HashMap<String, Object>();
		String orderNum = null;
		if (res.has("orderNum")) {
			orderNum = res.getString("orderNum");
...
//获取菜品详情
	public Map<String, Object> getGoodsDetails(JSONObject res) {
		Map<String, Object> returnData = new HashMap<String, Object>();
		String machineId = null;
		if (res.has("machineId")) {
			machineId = res.getString("machineId");
