...
public class OrderWeChatService {
	 ...
	 * @return
	 */
	public Map<String, Object> getOrdersByStatusWX(@SuppressWarnings("rawtypes") Map map) {
...
//		if ("-1".equals(map.get("orderStatus"))) {
	 ...
	 */
	@Transactional
	public Map<String, Object> getOrderCountByStatusWX(int customerId) {
...
//				}
	 ...
	 */
	@Transactional
	public void customerOrderDeleteWX(Map map){
		//删除总订单信息
