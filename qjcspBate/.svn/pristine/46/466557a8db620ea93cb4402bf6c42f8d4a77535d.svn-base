			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<%-- <input name="cityCode" id="cityCode" value="${basicsMachine.cityId}" class="easyui-combobox" required="required" data-options="width:170,valueField:'id',textField:'name',editable:false"/> --%>
				...
				<tr>
					...
					<td>
						...
						<input id="latitude" name="latitude" placeholder="纬度" class="easyui-numberbox easyui-validatebox" data-options="min:0,max:90,precision:10" value="${basicsMachine.latitude}" style="width: 78px;" required="required"/>
					</td>
			 	...
			 	<tr>
			 		<th>描述</th>
					<td colspan="3"><textarea class="easyui-textbox" id="machineMemo" name="machineMemo"  style="width: 300px;height: 68px;resize:none;" >${basicsMachine.machineMemo}</textarea>
					<em id="word">字数限制：100</em></td>
				</tr>
			</table>
		</form>
	</div>
...
<script type="text/javascript">
	/* <c:if test="${not empty basicsMachine.modelId}">
