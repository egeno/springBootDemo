...
<script type="text/javascript" src="<%=basePath%>views/statistics/everyOrderDiscountActivity/js/listEveryOrderDiscountActivityMain.js"></script>
</head>
<body>
...
<!-- 					<a href="javascript:void(0);" class="easyui-linkbutton" style="margin-left:20px" iconCls="icon-excel" onclick="exportOrderList()">导出</a> -->
	...
	<table id="dg" title="每单优惠活动订单列表"></table>
</body>
</html>
