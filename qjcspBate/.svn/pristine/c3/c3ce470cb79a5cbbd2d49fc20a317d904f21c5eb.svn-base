...
<script type="text/javascript">
	$(function() {
		$("#form").form({
			url :"shiro/persistenceShiroPlaUserEdit", //编辑、添加平台用户
			onSubmit : function() {
			...
			<input name="userId" id="userId"  type="hidden"/>
			 <table>
				 ...
				 <tr>
					...
					<td><input name="userMobile" id="userMobile" validtype="mobile" type="text" class="easyui-textbox easyui-validatebox" required="required" onblur="check()"/><a id="checkSpan" style="color: red;font-size:12px"></a></td>
				 </tr>
				 <tr>
				    <th>用户电话</th>
					<td><input id="userTel" name="userTel" validtype="phoneRex" type="text" class="easyui-textbox easyui-validatebox"/></td>
					<th>电子邮箱</th>
					<td colspan="3"><input id="userEmail" name="userEmail" validType="email" type="text" class="easyui-textbox easyui-validatebox"/></td>
				 </tr>
				 <tr>
				    <th>描述</th>
					<td colspan="3">
