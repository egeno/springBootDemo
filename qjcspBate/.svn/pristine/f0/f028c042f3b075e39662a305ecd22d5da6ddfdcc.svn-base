...
<script type="text/javascript"
	src="<%=basePath%>views/statistics/everydaySales/js/everydaySales.js"></script>
</head>
<body>
	<div id="panel" data-options="border:false">
		<div id="tb" style="padding: 5px">
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td style="padding-left: 20px">供销日期： <input id="psdate"
		...
		<table id="dg" title="柜子日销售量统计"></table>
	</div>
</body>
</html>
