...
$(function(){
	 ...
	 $grid = $dg.datagrid({//父表
		width : 'auto',
		height :  $(this).height(),
		url : "statistics/findFirstOrderPage",
		queryParams:{},
		rownumbers:true,
		fit:false,
		fitColumns:true,
		...
		columns : [ [
         	...
         	{field : 'mobile',title : '手机号',align : 'center', formatter:function(value, row, index){
...
/*             		{field : '1',title : '总毛利',align : 'center'},
         	...
         	{field : 'orderStatus',title : '订单状态',align : 'center', formatter:function(value, row, index){
         		var statusJson = {
         			0: "待付款",
         			1: "已支付(待取货)",
         			2: "已取消",
