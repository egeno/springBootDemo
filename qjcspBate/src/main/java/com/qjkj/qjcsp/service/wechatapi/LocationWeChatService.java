...
@Service
public class LocationWeChatService {
	 ...
	 * @return
	 */
	public Map<String, Object> getAllUniversitiesListWX(JSONObject res){
	 ...
	 * @return
	 */
	public Map<String, Object> getAllMachinesListWX(JSONObject res){
		Map<String, Object> returnData = new HashMap<String, Object>();
	 ...
	 * @return
	 */
	public Map<String, Object> fuzzySearchCityWX(JSONObject res){
		Map<String, Object> returnData = new HashMap<String, Object>();
		List<Map<String, Object>> returnContent = new ArrayList<Map<String,Object>>();
	 ...
	 * @return
	 */
	public Map<String, Object> fuzzySearchUniversityWX(JSONObject res){
		Map<String, Object> returnData = new HashMap<String, Object>();
		List<Map<String, Object>> returnContent = new ArrayList<Map<String,Object>>();
		if (res.has("keywords") && StringUtils.isNotBlank(res.getString("keywords"))){
