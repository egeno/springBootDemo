...
@Component
@Transactional
public class OrderCancelWeChatApiService {

	private static final Logger logger = LoggerFactory.getLogger(OrderCancelWeChatApiService.class);

	@Autowired
	private OrderWeChatUtilService orderWeChatUtilService;
	 ...
	 * @return
	 */
	public Map<String, Object> cancelOrderWX(JSONObject res) {
...
//			tblTemporaryRetailMapper.updByOrderId(tblOrder.getOrderId());
	...
	public void retailUnlockItem(String orderNum) {
		...
		TblOrder tblOrder = tblOrderMapper.selectByOrderNum(orderNum);
		/* 解锁单品 */
		orderWeChatUtilService.unlockItemNoPaid(tblOrder.getOrderId());
		/* 删除该待处理订单 */
		tblPendingOrderMapper.deletebyOrderNum(orderNum);
	}
