package com.qjkj.qjcsp.service.balancepay;
...
//	private TblDayMealsLogService tblDayMealsLogService;
	...
	@Transactional
	public Map<String,Object> balancePay(String orderNum,BigDecimal realMoney,Long customerId){
		//首先判断该订单是否已经取消了
...
//	    BigDecimal b=balancePayMapper.getUserRealMoney(orderNum);
	...
	public int checkHasUser(Long customerId,String password){
