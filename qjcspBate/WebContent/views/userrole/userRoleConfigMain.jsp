		...
		$(function() {
			...
			$user.datagrid({
				...
				columns : [ [ {field : 'userId',title : '用户ID',align : 'center',align : 'left',editor : "text"},
				             <%--/*  {field : 'userCode',title : '用户编码',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"}, */--%>
				              /* {field : 'companyName',title : '公司名称',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"}, */
			...
			$grid = $role.datagrid({
					...
					columns : [ [ {field:'ck',checkbox:true},
					              /* {field : 'companyName',title : '公司名称',width :  parseInt($(this).width()*0.1),align : 'center',editor : "text"}, */
