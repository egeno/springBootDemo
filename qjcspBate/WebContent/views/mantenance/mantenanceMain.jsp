...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>views/mantenance/js/mantenanceMain.js"></script>
  </head>
  <body>
   ...
   <div id="panel"  data-options="border:false">
		...
		<div data-options="region:'north',border:false" title="" style="height: 82px; overflow: hidden; padding: 5px;">
			<div class="well well-small">
				...
				<p>
					为维修员分配设备，请<span class="label-info"><strong>双击用户</strong></span>查看所属设备！
				</p>
			</div>
		</div>
