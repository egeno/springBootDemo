...
<script type="text/javascript">
	$(function() {
		...
		$("#form").form({
			url :"merchant/persistenceMerchantDlg",
			onSubmit : function() {
...
<script type="text/javascript" src="<%=basePath %>views/merchant/js/address.js"></script>
			...
			<input name="creater" id="creater"  type="hidden"/>
			 <table>
				...
				<tr>
					...
					<td>
					<input id="companyName" class="easyui-combobox" name="companyName" validType="length[0,20]" style="width:200px;" data-options="width:170,valueField:'name',textField:'name',editable:true" placeholder="可模糊查询公司名称"/>
					...
					<th><b class="red">*</b>公司简称</th>
					<td><input id="companyAlias" name="companyAlias" required="required" validType="length[0,10]" type="text" class="easyui-textbox easyui-validatebox"/></td>
				</tr>
				<tr>
				    <!-- <th>公司编号</th>
					<td><input name="companyCode" id="companyCode" type="text" class="easyui-textbox easyui-validatebox" /></td> -->
					<th><b class="red">*</b>公司前缀</th>
					<td><input id="companyPrefix" name="companyPrefix" required="required" validType="length[0,10]" type="text" class="easyui-textbox easyui-validatebox"/></td>
					<th>公司法人</th>
				 ...
				 <tr>
					...
					<td><input id="address" name="address" class="easyui-textbox easyui-validatebox" validType="length[0,30]" required="required"/></td>
					<th>经 / 纬度</th>
					<td>
...
<script type="text/javascript" src="<%=basePath %>views/merchant/js/fuzzyQuery.js"/>
<script type="text/javascript">
	province("");
</script>
