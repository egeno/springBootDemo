		...
		<form id="addForm" method="post">
			 <table>
				...
				<tr>
					...
					<td>
						<input name="companyId"  class="easyui-textbox" id="companyId" type="text" required="required"/>
				...
				<tr>
					...
					<td>
						<input name="machineZoneId" id="machineZoneId"  validType="length[2,30]" class="easyui-combobox" data-options="width:170,valueField:'id',textField:'name',editable:false" required="required"/>
				...
				<tr>
					...
					<td>
						<input id="longitude" name="longitude" placeholder="经度" class="easyui-numberbox easyui-validatebox" data-options="min:0,max:180,precision:10" style="width: 77px;" required="required"/> / 
						<input id="latitude" name="latitude" placeholder="纬度" class="easyui-numberbox easyui-validatebox" data-options="min:0,max:90,precision:10" style="width: 77px;" required="required"/>
					</td>
