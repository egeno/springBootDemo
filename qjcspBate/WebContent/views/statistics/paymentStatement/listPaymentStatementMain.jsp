...
<script type="text/javascript" src="<%=basePath%>views/statistics/paymentStatement/js/listPaymentStatementMain.js"></script>
	...
	<div id="tb" style="padding: 10px">
		<table cellpadding="5" cellspacing="0" style="width: 100%;">
			<tr>
				...
				<td style="width: 16%;">
					<div>
						<span>订单号：</span><input name="orderNum" id="orderNum" placeholder="模糊搜索订单" type="text" style="width: 100px;"/>					
					</div>
				</td>
				<td style="width: 16%;">
					<div style="text-align: center; vertical-align:middle;width:190px;">
						<span>下单方式：</span>
				     	<select id="modeNum" class="easyui-combobox" panelHeight="auto" style="width:100px;">   
				...
				<div style="text-align: center; vertical-align:middle;width:190px;">
						<span>支付方式：</span>
				     	<select id="payMode" class="easyui-combobox" panelHeight="auto" style="width:120px;">   
						   <option value="-1" selected>全部</option>
				...
				<td style="width: 16%;">
					<div>
						<span>用户名：</span><input name="mobile" id="mobile" placeholder="模糊搜索用户" type="text" style="width: 120px;"/>					
					</div>
				</td>
			</tr>
		</table>
