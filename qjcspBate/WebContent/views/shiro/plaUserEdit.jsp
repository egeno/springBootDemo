			...
			<input name="userId" id="userId"  type="hidden"/>
			 <table>
				 ...
				 <tr>
					...
					<td><input name="userMobile" id="userMobile" validtype="mobile" type="text" class="easyui-textbox easyui-validatebox" required="required" /><a id="checkSpan" style="color: red;font-size:12px"></a></td>
					<th>用户电话</th>
					<td><input id="userTel" name="userTel" validtype="phoneRex" type="text" class="easyui-textbox easyui-validatebox"/></td>
				 </tr>
				 <tr>
					<th>电子邮箱</th>
					<td><input id="userEmail" name="userEmail" validType="email" type="text" class="easyui-textbox easyui-validatebox"/></td>
				 </tr>
				 <tr>
				    <th>描述</th>
					<td colspan="3">
