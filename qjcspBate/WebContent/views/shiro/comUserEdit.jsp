			...
			<input name="userId" id="userId"  type="hidden"/>
			 <table>
				 <tr>
					...
					<td>
						<input name="userName" id="userName" validType="length[2,16]" required="required" class="easyui-textbox easyui-validatebox" type="text" />
					...
					<td>
						<input name="userAccount" id="userAccount" validType="account[6,16]" required="required" class="easyui-textbox easyui-validatebox" type="text" />
