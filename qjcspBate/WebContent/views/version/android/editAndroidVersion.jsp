...
<script type="text/javascript">
	$(function() {
		...
		$("#editForm").form({
			url :"version/android/editVersion",
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 10px;">
		<form id="editForm" method="post">
		    <input name="id" id="id"  type="hidden" value="${tblAndroidVersion.id}"/>
			 <table>
				<tr>
				    <th><b class="red">*</b>版本号</th>
				    
				    <td><input name="version" id="version" validType="length[1,10]" placeholder="请输入版本号" class="easyui-textbox easyui-validatebox" type="text" value="${tblAndroidVersion.version}"/></td>				   
				 </tr> 
				 <tr>
				    <th>更新内容</th>
					<td colspan="4">
				 ...
				 <tr>
				    ...
				    <td><input name="updateUrl" id="updateUrl" validType="length[1,100]" placeholder="请输入URL" class="easyui-textbox easyui-validatebox" type="text" value="${tblAndroidVersion.updateUrl}"/></td>				   
				 </tr> 
