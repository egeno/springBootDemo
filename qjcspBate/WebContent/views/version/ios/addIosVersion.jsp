			 ...
			 <table>
				 ...
				 <tr>
				  ...
				  <tr>
				    ...
				    <td><input name="versionValue" id="versionValue" validType="length[0,1]" placeholder="请输版本的值" maxlength=2 class="easyui-textbox easyui-validatebox" type="text"/></td>				   
				 </tr> 	
				 ...
				 <!-- <tr>
				    <th>更新内容</th>
					<td colspan="3">
						<textarea class="easyui-textbox" id="updateContent" name="updateContent"  style="width: 300px;height: 68px;resize:none;" ></textarea>
				...
				<!--  <tr>
				    ...
				    <td><input name="updateUrl" id="updateUrl" validType="length[1,100]" placeholder="请输URL" class="easyui-textbox easyui-validatebox" type="text"/></td>				   
				 </tr> 				  
				  <tr>  
