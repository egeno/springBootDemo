...
<script type="text/javascript">
	...
	function changes()
	{
		...
		var content = height-50;
		$(".content").css({"height":content});
		var accoun_height = $(".accoun").height();
		var message_height = height - 50 - 40 -36 - 60 - accoun_height;
		$(".message").css({"height":message_height});
	}
</script>
...
<script type="text/javascript">
	...
	(
		function()
		{
			...
			$(this).css({"background":"url(img/user.png) no-repeat center #fff"});
			$(this).css({"background-size":"contain"});
			$(this).find("a").css({"color":"#369fe1"});
		},
		function(){
			$(".userName").slideUp("fast");
			$(this).css({"background":"url(img/user2.png) no-repeat center #2aa2ed"});
			$(this).css({"background-size":"contain"});
